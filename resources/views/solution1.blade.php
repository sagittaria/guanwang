...
<!--banner-->
<div id="banner">
	<img src="{{ asset('images/solve.jpg') }}"/>
</div>
<!--banner end-->
	...
	<div class="center">
		<div class="left fl">
			<ul>
				...
				<li><a href="/solution/1" style="background: #fff;color: #498fe0;border-left: 2px solid #498fe0;box-sizing: border-box;padding: 20px 0 20px 18px;">化工与环境</a></li>
				<li><a href="/solution/2">食品安全</a></li>
