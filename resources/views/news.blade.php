	...
	<div class="center">
		<div class="left fl">
			<ul>
				...
				<li><a href="/news" style="background: #fff;color: #498fe0;border-left: 2px solid #498fe0;box-sizing: border-box;padding: 20px 0 20px 18px;">公司动态</a></li>
